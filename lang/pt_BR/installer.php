...
return [
    ...
    'installed' => [
        'success_log_message' => 'Food Appi installer successfully INSTALLED on ',
        'update_log_message'  => 'Food Appi Installer successfully UPDATED on ',
    ],
];
